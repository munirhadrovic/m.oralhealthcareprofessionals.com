...
<html>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
		    <h1>Mobile Site | <a href="http://www.oralhealthcareprofessionals.com/" rel="external">Classic Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Office</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">What Sets Us Apart?</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Quarterly Newsletter</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                ...
                <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Appointment Request</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Offers</a></div>
				</div>

                <h2>Welcome</h2>
                    <p>Welcome to the official webpage of Oral Health Care Professionals, LLC!  As you navigate through the site, you will find a wealth of information about the field of dentistry and the services we provide.
                        This website, as well as our other social media sites, are always changing so check back often!</p>

              <iframe width="auto" height="auto" src="https://www.youtube.com/embed/PciNpg1fwBo" frameborder="0" allowfullscreen></iframe>
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu-home">
						<ul id="menu-home">
							...
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Office</a></li>
							...
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">What Sets Us Apart?</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Quarterly Newsletter</a></li>
							<li><a href="#contactform" data-transition="<?php echo $transitionefect ?>">Contact US</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Offers</a></li>
						</ul>
					</section>
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu-contact">
							<ul id="menu-contact">
								...
								<li><a href="#home" data-transition="<?php echo $transitionefect ?>">Contact US</a></li>
							</ul>
					</section>	
					<div>
